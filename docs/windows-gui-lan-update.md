...
Windows GUI 默认使用 GitHub Release 公网源。当目标电脑不能访问 GitHub，或需要在局域网内加速下载时，可以在「软件更新」页切换到以下备用版本清单地址：
...
2. 在更新源列表中点击「局域网备用」右侧的「使用」，确认版本清单地址为 `http://172.16.15.15/latest.json`。
3. 点击「检查更新」。
